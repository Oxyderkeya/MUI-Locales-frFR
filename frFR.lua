...
L["Frame Inset"]					= "Encart de la fenêtre";
L["Colors"]							= "Couleurs";
L["Normal Casting"]					= "Lancement normal";
L["Finished Casting"]				= "Lancement fini";
L["Interrupted"]					= "Interrompu";
L["Latency"]						= "Latence";
L["Backdrop"]						= "Arrière plan";
L["Individual Cast Bar Options"]	= "Option individuelle de barre de sort";
...
L["Width"]							= "Largeur";
L["Height"]							= "Hauteur";
L["Frame Strata"]					= "Couches de fenêtre";
L["Frame Level"]					= "Niveau de fenêtre";
...
L["Show Tracking Menu"]				= "Montrer le menu de suivi";
...
L["General"]						= "Général";
L["Master Font"]					= "Palice principale";
...
L["Objective (Quest) Tracker"]		= "Suivi d'objectif (quête)";
L["Anchor to Side Bar"]				= "Ancrer à la barre latérale";
L["Set Width"]						= "Définir la largeur";
L["Set Height"]						= "Définir la hauteur";
L["Bottom UI Panels"]				= "Panneau d'interface inférieur";
L["Container Width"]				= "Largeur du conteneur";
L["Unit Panels"]					= "Panneau des unités";
L["Enable Unit Panels"]				= "Activer le panneau des unités";
L["Symmetric Unit Panels"]			= "";
L["Name Panels"]					= "Nom des panneaux";
L["Unit Panel Width"]				= "Largeur du panneau des unités";
L["Target Class Colored"]			= "Classe cible colorée";
L["Action Bar Panel"]				= "Panneau de barre d'action";
L["Enable Action Bar Panel"]		= "Activer le panneau de barre d'action";
