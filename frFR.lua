...
--L["Backdrop Inset"]				= "";
L["Chat Frame Options"]				= "Options de la fenêtre de tchat";
L["Enable Chat Frame"]				= "Activer la fenêtre de tchat";
L["Options"]						= "Options";
...
L["List of slash commands:"]								= "List des commandes slash";
...
L["ALT + Left Click:"]				= "ALT + Clic gauche";
L["Move Minimap"]					= "Bouger la Minimap";
L["Resize Minimap"]					= "Redimensionner la Minimap";
L["Ping Minimap"]					= "Ping la Minimap";
